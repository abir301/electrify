      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="bg-primary-600 hover:bg-primary-700 font-medium py-2 px-4 rounded-lg transition-colors duration-200 text-sm flex items-center space-x-1 group-hover:shadow-md border-2 border-transparent hover:border-primary-500 shadow-lg hover:shadow-xl"
          >
